...
async function E3_BenchmarkCanvas(Obj) {
   const BenchmarkHUDObj = {                     //S0_GenerateHUDCanvas
      ...
      BarSize: [
         ...
         { Width: "5%h", Height: null },    //3 BARRA BENCHMARK 1
         { Width: "5%h", Height: null },    //4 BARRA BENCHMARK 2
         { Width: "5%h", Height: null },    //5 BARRA VertexUniformVectors
         { Width: "5%h", Height: null },    //6 BARRA FragmentUniformVectors
         { Width: "5%h", Height: null },    //7 BARRA VaryingVectors
         { Width: "5%h", Height: null },    //8 BARRA PRECISION
      ],
      BarPos: [
         ...
         { RightFlag: "Right", PosX: null, TopFlag: "Top", PosY: null },      //3 BARRA BENCHMARK 1
         { RightFlag: "Right", PosX: null, TopFlag: "Top", PosY: null },      //4 BARRA BENCHMARK 2
         ...
         { RightFlag: "Right", PosX: null, TopFlag: "Top", PosY: null },      //7 BARRA VaryingVectors
         { RightFlag: "Right", PosX: null, TopFlag: "Top", PosY: null },      //8 BARRA PRECISION
      ],
...
async function E3_Benchmark() {
   ...
   if (isWebGL2) out.limits.supportsStandard = true;
   else {
      const exts = gl.getSupportedExtensions() || [];
