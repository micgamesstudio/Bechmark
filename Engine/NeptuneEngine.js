...
async function E3_BenchmarkCanvas(Obj) {
   const BenchmarkHUDObj = {                     //S0_GenerateHUDCanvas
      ...
      PulsSize: [
         ...
         { Width: "50%", Height: "50%" },      //1 CHECK
         { Width: "50%", Height: "10%" },      //2 SCORE BENCHMARK 1
         { Width: "50%", Height: "10%" },      //3 SCORE BENCHMARK 2
         { Width: "40%", Height: "12%" },      //4 START
      ],
      PulsPos: [
         { RightFlag: "Left", PosX: "25%", TopFlag: "Top", PosY: "55%" },      //0 VERSIONE ENGINE
         { RightFlag: "Right", PosX: "25%", TopFlag: "Top", PosY: "25%" },      //1 CHECK
         { RightFlag: "Right", PosX: "25%", TopFlag: "Top", PosY: "55%" },      //2 SCORE BENCHMARK 1
         { RightFlag: "Right", PosX: "25%", TopFlag: "Top", PosY: "70%" },      //3 SCORE BENCHMARK 2
         { RightFlag: "Left", PosX: "25%", TopFlag: "Top", PosY: "75%" },      //4 START
      ],
      PulsColor: [
         Obj.Color1,     //0 START
         Obj.Color1,     //1 CHECK
         Obj.Color1,     //2 SCORE BENCHMARK 1
         Obj.Color1,     //3 SCORE BENCHMARK 2
         Obj.Color1,     //4 START
      ],
      //BARRE
      Barre: 2,
      BarName: ["", ""],
      BarSize: [
         { Width: "5%h", Height: "50%w" },    //0 BENCHMARK 1
         { Width: "5%h", Height: "50%w" },    //1 BENCHMARK 2
      ],
      BarPos: [
         { RightFlag: "Right", PosX: "25%", TopFlag: "Top", PosY: "62.5%" },      //0 BARRA BENCHMARK 1
         { RightFlag: "Right", PosX: "25%", TopFlag: "Top", PosY: "77.5%" },      //1 BARRA BENCHMARK 2
      ],
      BarColor: [Obj.Color1, Obj.Color1],
      BarColorValue: [Obj.Color2, Obj.Color2],
      BarRotate: ["90", "90"],
      //IMMAGINI
      Immagini: 1,
      ImgSize: [
   ...
   function DrawHud() {
      ...
      BenchmarkHUDCanvas.setButtonText(1, `Device: ${Performance.evaluation.deviceType}
      ...
      BenchmarkHUDCanvas.setButtonText(2, `${Performance.benchmark[0]} ${Performance.detect.Score1}`);
      BenchmarkHUDCanvas.setButtonText(3, `${Performance.benchmark[1]} ${Performance.detect.Score2}`);

      BenchmarkHUDCanvas.setBarValue(0, Performance.detect.Bar1);
      BenchmarkHUDCanvas.setBarValue(1, Performance.detect.Bar2);
   };
   DrawHud();
   ...
   function windowResizeHandler() {
      ...
      if (window.innerWidth >= window.innerHeight) {
         ...
         BenchmarkHUDObj.PulsSize[1].Height = "50%";
         BenchmarkHUDObj.PulsPos[1].PosX = "25%";
         BenchmarkHUDObj.PulsPos[1].PosY = "25%";
         //2 SCORE BENCHMARK 1
         BenchmarkHUDObj.PulsSize[2].Width = "50%";
         BenchmarkHUDObj.PulsPos[2].PosX = "25%";
         BenchmarkHUDObj.PulsPos[2].PosY = "55%";
         //3 SCORE BENCHMARK 2
         BenchmarkHUDObj.PulsSize[3].Width = "50%";
         BenchmarkHUDObj.PulsPos[3].PosX = "25%";
         BenchmarkHUDObj.PulsPos[3].PosY = "70%";
         //4 START
         BenchmarkHUDObj.PulsSize[4].Width = "40%";
         BenchmarkHUDObj.PulsPos[4].PosX = "25%";
         BenchmarkHUDObj.PulsPos[4].PosY = "75%";


         //0 BARRA BENCHMARK 1
         BenchmarkHUDObj.BarSize[0].Height = "50%w";
         BenchmarkHUDObj.BarPos[0].PosX = "25%";
         BenchmarkHUDObj.BarPos[0].PosY = "62.5%";
         //1 BARRA BENCHMARK 2
         BenchmarkHUDObj.BarSize[1].Height = "50%w";
         BenchmarkHUDObj.BarPos[1].PosX = "25%";
         BenchmarkHUDObj.BarPos[1].PosY = "77.5%";
      }
      //ORIENTAMENTO VERTICALE
      else {
         //0 VERSIONE ENGINE
         BenchmarkHUDObj.PulsSize[0].Width = "50%";
         BenchmarkHUDObj.PulsPos[0].PosX = "75%";
         BenchmarkHUDObj.PulsPos[0].PosY = "10%";
         //1 CHECK
         BenchmarkHUDObj.PulsSize[1].Width = "100%";
         BenchmarkHUDObj.PulsSize[1].Height = "30%";
         BenchmarkHUDObj.PulsPos[1].PosX = "50%";
         BenchmarkHUDObj.PulsPos[1].PosY = "55%";
         //2 SCORE BENCHMARK 1
         BenchmarkHUDObj.PulsSize[2].Width = "100%";
         BenchmarkHUDObj.PulsPos[2].PosX = "50%";
         BenchmarkHUDObj.PulsPos[2].PosY = "75%";
         //3 SCORE BENCHMARK 2
         BenchmarkHUDObj.PulsSize[3].Width = "100%";
         BenchmarkHUDObj.PulsPos[3].PosX = "50%";
         BenchmarkHUDObj.PulsPos[3].PosY = "90%";
         //4 START
         BenchmarkHUDObj.PulsSize[4].Width = "50%";
         BenchmarkHUDObj.PulsPos[4].PosX = "75%";
         BenchmarkHUDObj.PulsPos[4].PosY = "25%";

         //0 BARRA BENCHMARK 1
         BenchmarkHUDObj.BarSize[0].Height = "100%w";
         BenchmarkHUDObj.BarPos[0].PosX = "50%";
         BenchmarkHUDObj.BarPos[0].PosY = "82.5%";
         //1 BARRA BENCHMARK 2
         BenchmarkHUDObj.BarSize[1].Height = "100%w";
         BenchmarkHUDObj.BarPos[1].PosX = "50%";
         BenchmarkHUDObj.BarPos[1].PosY = "97.5%";
      };
